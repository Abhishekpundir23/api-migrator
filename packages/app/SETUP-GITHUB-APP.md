...
Generate a private key, install the App on the approved repositories, and configure:
...
The `.env` loader accepts a quoted multiline private key. In a shell, it can instead be loaded without writing it to `.env`:
